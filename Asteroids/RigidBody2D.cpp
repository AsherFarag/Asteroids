...
{
	m_LinearAcceleration = Vector3Scale( Vector3Normalize(Vec3{ m_AttachedObjectTransform->GetGlobalMatrix().m0, m_AttachedObjectTransform->GetGlobalMatrix().m4 }), a_LinearSpeed);
}
